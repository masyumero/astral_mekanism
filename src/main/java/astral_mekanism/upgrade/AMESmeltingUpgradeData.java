...
public class AMESmeltingUpgradeData extends MachineUpgradeData {

    public final IInfusionTank stored;
    public final GasMode gasMode;

    public AMESmeltingUpgradeData(boolean redstone, IRedstoneControl.RedstoneControl controlType, IEnergyContainer energyContainer, int operatingTicks, GasMode gasMode, EnergyInventorySlot energySlot, IInfusionTank stored, InputInventorySlot inputSlot, OutputInventorySlot outputSlot, List<ITileComponent> components) {
